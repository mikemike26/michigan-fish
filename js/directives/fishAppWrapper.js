angular.module('fishApp').directive('fishAppWrapper', function(AnglerData, CityData, MapData) {
   return {
       ...
       link: function(scope, element, attrs) {
           var options, cities, circles, circle, itemsByCity;
            AnglerData.getAll().then(function(data) {
                options = AnglerData.getOptions(data);
                itemsByCity = AnglerData.sortByOption(options, "angler_s_city", data);
                console.log(itemsByCity);
                 ...
                 circles = MapData.getCircles(itemsByCity);
                console.log(circles);
           ...
           AnglerData.getAllByBait = function() {

           };
           AnglerData.getAllByMethod = function() {

           };
           AnglerData.getAllBySpecies = function() {
